...
$mesActual = date("m");
    ...
    echo "<ul>
            <li><h6><a href='calendari-sortides-dia.php?&month=".$mesActual."&year=".$anyActual."&day=".$diaActual."'>Veure les sortides d'avui al parking</a></h6></li>
        </ul><br>";
    ...
    if (!empty($result)) {
        ...
        foreach($result as $row) {
            ...
            switch ($mes2) {
                ...
                echo "<tr>";
                echo "<td><a href='calendari-sortides-mes.php?&month=".$mes2."&year=".$any2."'>".$mes3." // ".$any2."</a></td>";
                echo "</tr>";
            }
            echo "</tbody>";
            echo "</table>";
    ...
    $sql2 = "SELECT CAST(rc1.diaSalida AS DATE) AS mes
    FROM reserves_parking AS rc1
    GROUP BY YEAR(rc1.diaSalida)
    ORDER BY rc1.diaSalida ASC, rc1.horaSalida ASC";
    ...
    foreach($result as $row) {
        ...
        echo "<li><h6><a href='calendari-sortides-any.php?&year=".$any4."'>Any: ".$any4."</h6></li>";
