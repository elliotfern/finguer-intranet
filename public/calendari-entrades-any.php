...
if (isset($_GET['year'])) {
    ...
    echo "<h2>Calendari d'entrades: any ".$year_old ."</h2>";
    ...
    WHERE YEAR(rc1.diaEntrada) = $year_old
    ...
    if (!empty($result)) {
        ...
        foreach($result as $row) {
            ...
            switch ($mes2) {
                ...
                echo "<tr>";
                echo "<td><a href='calendari-entrades-mes.php?&month=".$mes2."&year=".$any2."'</a>".$mes3." ".$any2."</td>";
                echo "</tr>";
            }
            echo "</tbody>";
            echo "</table>";
    ...
    echo "<ul>";
    echo "<li><h6><a href='calendari-entrades.php'>Veure calendari d'entrades reserves</h6></li>";
    echo "</ul>";
