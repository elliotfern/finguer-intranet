...
if (isset($_GET['id'])) {
    ...
    if ( filter_var($id_old, FILTER_VALIDATE_INT) ) {
        ...
        $sql = "SELECT r.buscadores, r.idReserva
        ...
        if ($idReserva_old == 1) {
            echo "<h2>Modificació buscador client anual amb ID núm: ".$id_old." </h2>";
        } else {
            echo "<h2>Modificació buscador reserva número: ".$idReserva_old." </h2>";
        } 
              ...
              if (isset($_POST["update-buscadores"])) {
               ...
               // Si no hi ha cap error, envia el formulari
                ...
                if ($codi_resposta == 2) { 
                    ...
                    echo "<button id='update-buscadores' name='update-buscadores' type='submit' class='btn btn-primary'>Modificació buscador</button><a href='modificar-buscador.php'></a>
                    </div>";
