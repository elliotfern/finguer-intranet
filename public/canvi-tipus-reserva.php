...
if (isset($_GET['id'])) {
    ...
    if ( filter_var($id_old, FILTER_VALIDATE_INT) ) {
        ...
        foreach($result as $row) {
            ...
            echo "<h2>Canvi tipus de reserva</h2>";
              ...
              if (isset($_POST["update-tipus"])) {
               ...
               // Si no hi ha cap error, envia el formulari
                ...
                if ($codi_resposta == 2) { 
                    ...
                    echo "<button id='update-tipus' name='update-tipus' type='submit' class='btn btn-primary'>Actualizar</button><a href='canvi-tipus-reserva.php'></a>
                    </div>";
