...
<script>
function fetch_data(){
    let urlAjax = window.location.origin + "/api/reserves/get/?type=parking";
    $.ajax({
        url:urlAjax,
        method:"GET",
        dataType:"json",
        success:function(data){
            ...
            for (let i=0; i<data.length; i++) {
                ...
                if (dataEntradaAny == 1970) {
                    ...
                    html += '<a href="canvi-reserva-entrada.php?&id=' + data[i].id + '">' + dataEntrada2 + '</a> // <a href="canvi-reserva-entrada.php?&id=' + data[i].id + '">' + data[i].HoraEntrada + '</a>';
                }
                html += '</td>';
                ...
                if (dataSortidaAny == 1970) {
                    ...
                    html += '<strong><a href="canvi-reserva-sortida.php?&id=' + data[i].id + '">' + dataSortida2 + '</a> // <a href="canvi-reserva-sortida.php?&id=' + data[i].id + '">' + data[i].HoraSortida + '</a></strong>';
                }
                html += '</td>';
                ...
                html += '<td>';
                if (data[i].checkIn === 1) {
                    html += '<a href="fer-checkout.php?&id=' + data[i].id + '" class="btn btn-secondary btn-sm" role="button" aria-pressed="true">Check-Out</a>';
                }
                html += '</td>';
...
function fetch_data2(){
    let urlAjax = window.location.origin + "/api/reserves/get/?type=numReservesParking";
    $.ajax({
        url:urlAjax,
        method:"GET",
        dataType:"json",
